...
class SocialService {
  ...
  async getUserPosts(userId, limit = 20, offset = 0) {
    const response = await api.get(`/api/social/users/${userId}/posts`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async unlikePost(postId) {
    const response = await api.delete(`/api/social/posts/${postId}/like`);
    return response.data;
  }

  async getPostLikes(postId, limit = 50, offset = 0) {
    const response = await api.get(`/api/social/posts/${postId}/likes`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async getCommentReplies(commentId, limit = 20, offset = 0) {
    const response = await api.get(`/api/social/comments/${commentId}/replies`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async updateComment(commentId, content) {
    const response = await api.put(`/api/social/comments/${commentId}`, { content });
    return response.data;
  }
  ...
  async unlikeComment(commentId) {
    const response = await api.delete(`/api/social/comments/${commentId}/like`);
    return response.data;
  }
  ...
  async getFollowers(userId, limit = 50, offset = 0) {
    const response = await api.get(`/api/social/users/${userId}/followers`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async getFollowing(userId, limit = 50, offset = 0) {
    const response = await api.get(`/api/social/users/${userId}/following`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async blockUser(userId) {
    const response = await api.post(`/api/social/users/${userId}/block`);
    return response.data;
  }

  async unblockUser(userId) {
    const response = await api.delete(`/api/social/users/${userId}/block`);
    return response.data;
  }

  async getBlockedUsers(limit = 50, offset = 0) {
    const response = await api.get('/api/social/users/blocked', {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async sharePost(postId, sharedTo = 'feed') {
    const response = await api.post(`/api/social/posts/${postId}/share`, { shared_to: sharedTo });
    return response.data;
  }

  async reportPost(postId, reason, description = null) {
    const response = await api.post(`/api/social/posts/${postId}/report`, {
      reason,
      description,
    });
    return response.data;
  ...
  async getActivityFeed(limit = 50, offset = 0) {
    const response = await api.get('/api/social/activity/feed', {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async getTrendingHashtags(limit = 20) {
    const response = await api.get('/api/social/hashtags/trending', {
      params: { limit },
    });
    return response.data;
  }
  ...
  async getPostsByHashtag(tag, limit = 20, offset = 0) {
    const response = await api.get(`/api/social/hashtags/${tag}`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async searchHashtags(query, limit = 20) {
    const response = await api.get('/api/social/hashtags/search', {
  ...
  async createGroup(name, description, isPrivate = false, category = null) {
    const response = await api.post('/api/social/groups', {
      name,
      description,
  ...
  async updateGroup(groupId, updates) {
    const response = await api.put(`/api/social/groups/${groupId}`, updates);
    return response.data;
  }

  async deleteGroup(groupId) {
    const response = await api.delete(`/api/social/groups/${groupId}`);
    return response.data;
  }

  async joinGroup(groupId) {
    const response = await api.post(`/api/social/groups/${groupId}/join`);
    return response.data;
  }

  async leaveGroup(groupId) {
    const response = await api.delete(`/api/social/groups/${groupId}/join`);
    return response.data;
  }
  ...
  async getUserGroups(userId, limit = 20, offset = 0) {
    const response = await api.get(`/api/social/users/${userId}/groups`, {
      params: { limit, offset },
    });
    return response.data;
  }
  ...
  async createGroupPost(groupId, content, imageUrls = []) {
    const response = await api.post(`/api/social/groups/${groupId}/posts`, {
      content,
